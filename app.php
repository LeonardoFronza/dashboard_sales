<?php
    ...
    //Manipulando o Banco de dados (Model)
    ...
    $dashboard->__set('totalRecl', $bd->getTotalReclamacoes());
    $dashboard->__set('totalElog', $bd->getTotalElogios());
    $dashboard->__set('totalSuges', $bd->getTotalSugestoes());
    $dashboard->__set('totalDesp', $bd->getTotalDespesas());
